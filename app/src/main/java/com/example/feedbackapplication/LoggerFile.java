...
//    GPSTracker gpsTracker = new GPSTracker(new ApplicationClass().getContext());
    ...
    BaseActivity mainActivity = new BaseActivity();

    String MacAddres = mainActivity.getMacAddr();
    String DeviceName = mainActivity.DeviceDetails();
    ...
    public String[] loggerFunction(){
        ...
        return new String[]{Last_Date_Time,Last_IP,Update_Location,Apk_Web_Version,deviceName};
    }
}
