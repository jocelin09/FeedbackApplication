...
public class DatabaseHelper_Dell extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(" CREATE TABLE  feedback_questions (ID INTEGER PRIMARY KEY ,Auto_Id TEXT, Feedback_Question TEXT,Area_Id TEXT, RecordStatus TEXT,RatingValue TEXT)");
